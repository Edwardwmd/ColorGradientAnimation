...
//        Debug.init(new AndroidLogDebugOutput(true));
        ...
        mColorCanvas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ColorChangeFlagAnimator ccfAnimator = animator();
                mAnimator = ccfAnimator.asValueAnimator(new ColorChangeFlagAnimator.OnNewColorListener() {
                    @Override
    ...
    private ColorChangeFlagAnimator animator() {
        ...
        switch (mType) {
            ...
            case HSV:
                return ColorChangeFlagAnimator.hsv(fromColor, toColor);

            case HSV_WITH_ALPHA:
                final int fromAlpha = Color.alpha(fromColor);
                final int toAlpha = Color.alpha(toColor);
                return ColorChangeFlagAnimator.hsv(fromColor, toColor, fromAlpha, toAlpha);

            case RGB:
                return ColorChangeFlagAnimator.rgb(fromColor, toColor);

            case ARGB:
                return ColorChangeFlagAnimator.argb(fromColor, toColor);
