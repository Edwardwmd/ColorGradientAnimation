package com.wmd.color.demo.colorgradientanimation;
...
/**
 * Created by Wumingde on 22.9.2016.
 */
public abstract class ColorChangeFlagAnimator {
    ...
    /**
     * Concats specified array of {@link ColorChangeFlagAnimator} into a {@link ConcatAnimator}. Maybe be used to
     ...
     * @see #argb(int[])
     *
     * @param animators array of {@link ColorChangeFlagAnimator} to include in returned {@link ConcatAnimator}
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator concat(final ColorChangeFlagAnimator... animators) {
        return new ConcatAnimator(animators);
    }

    /**
     * Creates a {@link ColorChangeFlagAnimator} animate alpha of specified color
     *
     * @see #argb(int, int)
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator alpha(
            @ColorInt int color,
    ...
    /**
     * Creates a {@link ColorChangeFlagAnimator} to animate `fromColor` color to `toColor`. Alpha property will be ignored
     *
     * @see #argb(int, int)
     * @see #rgb(int[])
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator rgb(
    ...
    /**
     * Creates a {@link ColorChangeFlagAnimator} to animate between array of colors.
     * For each pair of colors RGB ColorChangeFlagAnimator will be created
     *
     * @see #rgb(int, int)
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator rgb(@Size(min = 2) int[] colors) {
        final ColorChangeFlagAnimator[] animators = new ColorChangeFlagAnimator[colors.length - 1];
        for (int i = 0, length = animators.length; i < length; i++) {
            animators[i] = ColorChangeFlagAnimator.rgb(colors[i], colors[i + 1]);
        }
        return concat(animators);
    }

    /**
     * Creates a {@link ColorChangeFlagAnimator} to animate `fromColor` color to `toColor`
     *
     * @see #rgb(int, int)
     * @see #argb(int[])
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator argb(
            @ColorInt int fromColor,
            @ColorInt int toColor
    ) {
    ...
    /**
     * Constructs a {@link ColorChangeFlagAnimator} from specified array of colors
     *
     * @see #argb(int, int)
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator argb(@Size(min = 2) int[] colors) {
        final ColorChangeFlagAnimator[] animators = new ColorChangeFlagAnimator[colors.length - 1];
        for (int i = 0, length = animators.length; i < length; i++) {
            animators[i] = ColorChangeFlagAnimator.argb(colors[i], colors[i + 1]);
        }
        return concat(animators);
    }

    /**
     * Creates a {@link ColorChangeFlagAnimator} to animate HSV of specified colors. Alpha property will be ignored
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator hsv(
            @ColorInt int fromColor,
            @ColorInt int toColor
    ) {
    ...
    /**
     * Creates a {@link ColorChangeFlagAnimator} to animate HSV of specified colors
     *
     * @see #hsv(int, int)
     * @see #hsv(int[])
     *
     ...
     * @return {@link ColorChangeFlagAnimator}
     */
    public static ColorChangeFlagAnimator hsv(@Size(min = 2) int[] colors) {

        final ColorChangeFlagAnimator[] animators = new ColorChangeFlagAnimator[colors.length - 1];
        for (int i = 0, length = animators.length; i < length; i++) {
            animators[i] = ColorChangeFlagAnimator.hsv(colors[i], colors[i + 1]);
        }
        return concat(animators);
    }
    ...
    protected ColorChangeFlagAnimator(int fromColor, int toColor) {
    ...
    protected static class RGBAnimator extends ColorChangeFlagAnimator {
    ...
    protected abstract static class AbsHSVAnimator extends ColorChangeFlagAnimator {
    ...
    protected static class ConcatAnimator extends ColorChangeFlagAnimator {

        private final ColorChangeFlagAnimator[] mAnimators;
        private final int mLength;
        private final float mFractionStep;

        protected ConcatAnimator(@NonNull ColorChangeFlagAnimator[] animators) {
            super(0, 0);
